...
//
// Replaces the Firebase callable `getCloudflareIceServers`. Holds the Cloudflare TURN key
// as Worker secrets (never on the device, never through Google) and returns the same
// { iceServers: [...] } shape the app already parses.
//
