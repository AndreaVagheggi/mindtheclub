...
import com.bolimot.mindtheclub.adapters.VideoFragmentAdapter
...
class VideoTab : BaseActivity(),   VideoGalleryFragment.OnImageSelectedListener,
    VideoCameraFragment.OnImageSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPager.adapter = VideoFragmentAdapter(supportFragmentManager, lifecycle, 2, multipleSelection)
