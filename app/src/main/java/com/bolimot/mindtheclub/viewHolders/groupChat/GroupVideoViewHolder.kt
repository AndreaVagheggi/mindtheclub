...
class GroupVideoViewHolder(itemView: View, private val listener: MessagesAdapter.OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
        ...
        try {
            message?.let {
                ...
                if (dimensions != null) {
                    ...
                    val layoutParamss = image.layoutParams
                    layoutParamss.width = fallbackSize
                    layoutParamss.height = fallbackSize
                    image.layoutParams = layoutParamss

                    val layoutParamss2 = insertContainer.layoutParams
                    layoutParamss2.width = fallbackSize
                    insertContainer.layoutParams = layoutParamss2
