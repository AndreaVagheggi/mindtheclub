...
class GroupTextImageViewHolder(itemView: View, private val listener: MessagesAdapter.OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
    ...
    private suspend fun getReplyImage(replyId: String, type: String): String? {
        return getMessageRepository(this@GroupTextImageViewHolder.itemView.context).getReplyImage(replyId, type)
    }

    private suspend fun getReplyType(replyId: String): String? {
        return getMessageRepository(this@GroupTextImageViewHolder.itemView.context).getReplyType(replyId)
    }
