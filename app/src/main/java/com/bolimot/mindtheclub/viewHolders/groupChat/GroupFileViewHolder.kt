    ...
    fun bind(message: Message?,
        ...
        try {
            message?.let {
                ...
                val detailList = getFileDetailFromType(message.type)

                itemView.findViewById<TextView>(R.id.fileName).text = detailList[0]
                itemView.findViewById<TextView>(R.id.fileExtension).text = detailList[1]
