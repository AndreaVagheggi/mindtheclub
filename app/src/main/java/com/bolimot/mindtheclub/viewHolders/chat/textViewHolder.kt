...
class TextViewHolder(itemView: View, private val listener: MessagesAdapter.OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(message: Message?, displayDateHeader: Boolean, isSelected: Boolean, subType: String?) {
        ...
        try {
            message?.let {
                ...
                val cardContainer = itemView.findViewById<LinearLayout>(R.id.card_container)
